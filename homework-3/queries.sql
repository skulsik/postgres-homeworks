...
SELECT customers.company_name, CONCAT(employees.first_name, ' ', employees.last_name), shippers.company_name
FROM orders
INNER JOIN customers USING(customer_id)
INNER JOIN employees USING(employee_id)
INNER JOIN shippers ON(ship_via = shipper_id)
WHERE ship_city = 'London' AND shippers.company_name = 'United Package';
